       ...
       <div className=" w-[100%] h-[90%] flex flex-row items-center justify-center">
        ...
        <div className="w-[50%] h-[100%]">
          <div className="relative w-[100%] h-[100%] flex flex-row items-center justify-center gap-[100rem]">
           <img className=" w-[20rem] bg-red-900 h-[40rem] rounded-md" src="/iceland.jpeg" alt="" />
           <img className=" w-[20rem] bg-blue-900 h-[40rem] rounded-md" src="/iceland.jpeg" alt="" />
           <img className=" w-[20rem] bg-yellow-900 h-[40rem] rounded-md" src="/iceland.jpeg" alt="" />
           <img className=" w-[20rem] bg-green-900 h-[40rem] rounded-md" src="/iceland.jpeg" alt="" />
          </div>
        </div>
       </div>
