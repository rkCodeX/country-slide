       ...
       <div className=" w-[100%] h-[90%] flex flex-row items-center justify-center">
        ...
        <div className="w-[50%] h-[100%]">
          <div className="relative w-full h-full flex items-center justify-center">
            <img className="w-[12rem] h-80 rounded-md z-[4]" src="/iceland.jpeg" alt="" />
            <img className="w-[12rem] h-80 rounded-md ml-[-5rem] z-[3]" src="/iceland.jpeg" alt="" />
            <img className="w-[12rem] h-80 rounded-md ml-[-5rem] z-[2]" src="/iceland.jpeg" alt="" />
            <img className="w-[12rem] h-80 rounded-md ml-[-5rem] z-[1]" src="/iceland.jpeg" alt="" />
          </div>
        </div>
       </div>
