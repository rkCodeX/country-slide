       ...
       <div className=" w-[100%] h-[90%] flex flex-row items-center justify-center">
        ...
        <div className="w-[60%] h-[100%]">
          <div className="relative w-full h-full flex items-end justify-end">
            <img className="border-2 bw-[12rem] h-[15rem] rounded-md z-[4]" src="/Iceland.jpeg" alt="" />
            <img className="border-2 bw-[12rem] h-[15rem] rounded-md ml-[-5rem] z-[3]" src="/Iceland.jpeg" alt="" />
            <img className="border-2 bw-[12rem] h-[15rem] rounded-md ml-[-5rem] z-[2]" src="/Iceland.jpeg" alt="" />
            <img className="border-2 bw-[12rem] h-[15rem] rounded-md ml-[-5rem] z-[1]" src="/Iceland.jpeg" alt="" />
          </div>
        </div>
       </div>
