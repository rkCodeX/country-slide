       ...
       <div className=" w-[100%] h-[90%] flex flex-row items-center justify-center">
        ...
        <div className="w-[50%] h-[100%]">
          <div className="relative w-[100%] h-[100%] flex flex-row items-center justify-center">
           <img className="w-[10rem] bg-red-900 h-[20rem] rounded-md" src="/iceland.jpeg" alt="" />
           <img className="w-[10rem] bg-blue-900 h-[20rem] rounded-md" src="/iceland.jpeg" alt="" />
           <img className="w-[10rem] bg-yellow-900 h-[40rem] rounded-md" src="/iceland.jpeg" alt="" />
           <img className="w-[10rem] bg-green-900 h-[40rem] rounded-md" src="/iceland.jpeg" alt="" />
          </div>
        </div>
       </div>
