     ...
     <div className="relative w-[100%] flex items-center justify-center h-screen">
       ...
       <div className=" w-[100%] h-[90%] flex flex-row items-center justify-center">
        <div className="w-[40%] h-[100%] flex items-center justify-center ">
         <div className="w-[65%] h-auto flex flex-col items-start gap-[0.8rem] justify-start">
          ...
          <p className="image text-md font-semibold text-justify select-none hover:text-[#0c6b4d] drop-shadow-[1px_5px_5px_#0c6b4d]">Capital: {countriesData[currentIndex]?.capital}</p>
          <p className="image text-md font-semibold text-justify select-none hover:text-[#0c6b4d] drop-shadow-[1px_5px_5px_#0c6b4d]">Population: {countriesData[currentIndex]?.population?.toLocaleString()}</p>
          <p className="image text-md font-semibold text-justify select-none hover:text-[#0c6b4d] drop-shadow-[1px_5px_5px_#0c6b4d]">Languages: {countriesData[currentIndex]?.languages?.join(', ')}</p>
          </div>
       ...
       <div className="w-[100%] h-[15%] flex items-center justify-center">
        <div className="w-auto h-auto flex items-center justify-center flex-row gap-[2rem]">
          ...
          {play ? <TiMediaPause onClick={() => show()} className="cursor-pointer p-[0.2rem] bg-[#0c6b4d] hover:bg-[#0b9b43] hover:transition delay-150 duration-300 ease-in-out rounded-full w-[3rem] border-2 border-[#083838] hover:scale-180 shadow-emerald-950 shadow-xl h-[3rem]"/> : <VscDebugStart onClick={() => show()} className="cursor-pointer p-[0.3rem] bg-[#0c6b4d] hover:bg-[#0b9b43] hover:transition delay-150 duration-300 ease-in-out rounded-full w-[3rem] border-2 border-[#083838] hover:scale-180 shadow-emerald-950 shadow-xl h-[3rem]"/>}
