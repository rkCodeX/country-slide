     ...
     <div className="relative w-[100%] flex items-center justify-center h-screen">
       ...
       <div className=" w-[100%] h-[90%] flex flex-row items-center justify-center">
        <div className="w-[40%] h-[100%] flex items-center justify-center ">
         <div className="w-[70%] h-auto flex flex-col items-start gap-[0.8rem] justify-start">
          ...
          <button className="cursor-pointer rounded-sm w-[6rem] h-[2.5rem] font-semibold bg-[#0b9b43] hover:bg-[#0c6b4d] hovtransition delay-150 duration-300 ease-in-out">See More</button>
         </div>
        </div>
       ...
       <div className="w-[100%] h-[10%] flex items-center justify-center">
        <div className="w-auto h-auto flex items-center justify-center flex-row gap-[2rem]">
          <button className="cursor-pointer bg-[#0c6b4d] hover:bg-[#0b9b43] ">next</button>
          <button className="cursor-pointer bg-[#0c6b4d] hover:bg-[#0b9b43] ">S/S</button>
          <button className="cursor-pointer bg-[#0c6b4d] hover:bg-[#0b9b43] ">prev</button>
        </div>
       </div>
       </div>
     </div>
