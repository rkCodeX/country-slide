       ...
       <div className=" w-[100%] h-[90%] flex flex-row items-center justify-center">
        ...
        <div className="w-[60%] h-[100%]">
          <div className="w-full h-full flex flex-row items-end justify-end pr-[10rem]">
            <img className="-mr-[6rem] hover:-translate-y-10 hover:drop-shadow-[0_5px_5px_#0c6b4d] z-[4] hover:transition-all  border-2 border-[#083838] w-[12rem] h-[15rem] rounded-2xl" src="/Iceland.jpeg" alt="" />
            <img className="-mr-[6rem] hover:-translate-y-10 hover:drop-shadow-[0_5px_5px_#0c6b4d] z-[3] hover:transition-all  border-2 border-[#083838] w-[12rem] h-[15rem] rounded-2xl" src="/norway.jpeg" alt="" />
            <img className="-mr-[6rem] hover:-translate-y-10 hover:drop-shadow-[0_5px_5px_#0c6b4d] z-[2] hover:transition-all  border-2 border-[#083838] w-[12rem] h-[15rem] rounded-2xl" src="/sweden.jpeg" alt="" />
            <img className="-mr-[6rem] hover:-translate-y-10 hover:drop-shadow-[0_5px_5px_#0c6b4d] z-[1] hover:transition-all  border-2 border-[#083838] w-[12rem] h-[15rem] rounded-2xl" src="/finland.jpeg" alt="" />
          </div>
        </div>
       </div>
