...
function Main(){
  ...
  const [textClass, setTextClass] = useState('text-enter');
 ...
 useEffect(() => {
    // Trigger animations when currentIndex changes
    setImageClass('image-enter');
    setTextClass('text-enter');

    const timer = setTimeout(() => {
      setImageClass('image-enter-active');
      setTextClass('text-enter-active');
    }, 50); // Delay to allow the enter class to take effect
