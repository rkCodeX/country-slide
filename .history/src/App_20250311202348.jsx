       ...
       <div className=" w-[100%] h-[90%] flex flex-row items-center justify-center">
        <div className="w-[40%] h-[100%] flex items-center justify-center ">
         <div className="w-[65%] h-auto flex flex-col items-start gap-[0.8rem] justify-start">
          ...
          <p className="text-md font-semibold text-justify select-none ho drop-shadow-[1px_5px_5px_#0c6b4d]">Capital: {countriesData[currentIndex]?.capital}</p>
          <p className="text-md font-semibold text-justify select-none ho drop-shadow-[1px_5px_5px_#0c6b4d]">Population: {countriesData[currentIndex]?.population?.toLocaleString()}</p>
          <p className="text-md font-semibold text-justify select-none ho drop-shadow-[1px_5px_5px_#0c6b4d]">Languages: {countriesData[currentIndex]?.languages?.join(', ')}</p>
          </div>
