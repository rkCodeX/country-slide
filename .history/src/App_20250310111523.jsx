    ...
    <>
     <div className="relative w-[100%] flex items-center justify-center h-screen">
       ...
       <div className="border-2 w-[100%] h-[90%]">
        <h1>FINLAND</h1>
        <p>Lorem ipsum, dolor sit amet consecteturdolor. Libero numquam delectus dolorum in recusandae nesciunt nostrum id, facilis quidem. Omnis necessitatibus iste laudantium. Quibusdam.</p>
       </div>
