...
function App() {
  ...
  return (
    <>
     <div className="relative text-[#0b9b43] w-[100%] flex items-center justify-center h-screen">
       ...
       <div className="border-2 w-[100%] h-[90%] flex flex-row items-center justify-center">
        <div className="w-[50%] h-[100%] flex items-center justify-center border-2">
         <div className="w-[70%] h-auto flex flex-col items-start gap-[0.5rem] justify-start">
          ...
          <p className="text-lg text-justify select-none">Lorem ipsum, dolor sit amet consectetur dolor. Libero  nostrum id, Quibusdam.</p>
